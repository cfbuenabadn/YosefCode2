...
python ~/project/singleCell/allon_script/preproc/processFolder.py --skip_tophat --skip_tophat_qc --rsem_bowtie_maxins 3000 -N brainPairedAsSingleOtherEnd -r mm10 -p 2 -o /home/eecs/allonwag/data/BRAIN/processed2/150202_HS2A/Project_Ngai_AsSingleOtherEnd /home/eecs/allonwag/data/BRAIN/sources/150202_HS2A/Project_Ngai
